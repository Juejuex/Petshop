...
urlpatterns = [
    ...
    path('producto/<str:categoria>/', views.productos_por_categoria, name='productos_por_categoria'),
    ...
    path('productos/<str:categoria_nombre>/<str:producto_nombre>/', views.producto_individual, name='producto_individual'),
    path('productos/<str:categoria_nombre>/<str:marca_nombre>/', views.productos_por_categoria_marca, name='productos_por_categoria_marca'),
